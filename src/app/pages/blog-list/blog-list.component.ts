...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, TiltDirective, NgOptimizedImage],
  template: `
    <div class="bg-gray-50 dark:bg-black min-h-screen">
       <!-- Hero Section -->
      <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        <img ngSrc="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply" 
             fill
             priority
             alt="" 
        ...
        <div class="flex flex-col gap-y-12">
          ...
          <article *ngFor="let post of (state$ | async)?.posts" 
            ...
            <div class="w-full md:w-[30%] shrink-0">
              <div class="relative h-full overflow-hidden rounded-xl min-h-[200px]">
                <img [ngSrc]="post.imageUrl" fill alt="" class="object-cover transform transition-transform duration-500 group-hover:scale-110">
